...
@property (nonatomic, strong) NSString *emptyOverlayStr;
@property (nonatomic, strong) NSString *imageName;
@property (nonatomic, strong) UIImageView *emptyOverlayImageView;

@end
@implementation XTWithdrawalPlaceHolder
- (instancetype)initWithFrame:(CGRect)frame emptyOverlay:(NSString *)emptyOverlay imageView:(NSString *)imageName{
    self = [super initWithFrame:frame];
    if (self) {
        _emptyOverlayStr = emptyOverlay;
...
- (void)addUIemptyOverlayLabel {
    ...
    emptyOverlayLabel.text = _emptyOverlayStr;
