...
//                [headImage sd_setImageWithURL:[NSURL URLWithString:headImgString] placeholderImage:[UIImage imageNamed:@"imageDefault"]];
        ...
        /*设置标题位置
         CGRect titleFrame;
         if (headImg.size.height<1) {
         titleFrame = CGRectMake(10, CGRectGetMaxY(headImage.frame)+5, Alertwidth-20, titleSize.height);
         }else{
         titleFrame = CGRectMake(10, (headImage.frame.size.height-titleSize.height)/2, Alertwidth-20, titleSize.height);
         }
         self.alertTitleLabel = [[UILabel alloc] init];
         self.alertTitleLabel.frame = titleFrame;
         */
...
//                [self.iconImageView sd_setImageWithURL:[NSURL URLWithString:iconString] placeholderImage:[UIImage imageNamed:@"imageDefault"]];
        ...
        if (hasText) {
            ...
            self.text = [[UITextField alloc] initWithFrame:CGRectMake(FieldX, FieldY, FieldW, FieldH)];
        ...
        if (leftTitle !=nil && rigthTitle==nil) {
        ...
        }else if (leftTitle==nil && rigthTitle!=nil){
            //只有右边按钮
            ...
            //两个按钮都有
            leftbtnFrame = CGRectMake(0, btnY, Alertwidth/2-0.25, WYButtonHeigth);
            rightbtnFrame = CGRectMake(CGRectGetMaxX(leftbtnFrame)+0.5, btnY, Alertwidth/2-0.25, WYButtonHeigth);
        }
        ...
        //UIView * centerView = [[UIView alloc] initWithFrame:CGRectMake(Alertwidth/2 - 0.5, btnY, 1, XWbuttonHeigth+5)];
